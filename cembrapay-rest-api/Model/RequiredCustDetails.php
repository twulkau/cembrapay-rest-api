...
/**
 * RequiredCustDetails Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequiredCustDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequiredCustDetails';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cust_type'] === null) {
            $invalidProperties[] = "'cust_type' can't be null";
        }
