...
/**
 * RequiredCembraPayDetails Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequiredCembraPayDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequiredCembraPayDetails';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cembra_pay_payment_method'] === null) {
            $invalidProperties[] = "'cembra_pay_payment_method' can't be null";
        }
