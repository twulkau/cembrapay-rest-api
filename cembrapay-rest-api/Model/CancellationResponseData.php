...
/**
 * CancellationResponseData Class Doc Comment
 *
 * @category Class
 * @description Details of processed cancellation (CAN).
 * @package  CembraPay\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CancellationResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CancellationResponseData';
     ...
     *
     * @param string $cancellation_id Id of cancellation
     *
     * @return $this
     */
